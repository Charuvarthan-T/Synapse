...
def test_prefix_guard_does_not_block_same_length_typos():
    ...
    a = _norm("GraphExtractor")
    b = _norm("GraphExtractar")
...
_DEFINING = {
    ...
    "label": "make-batch-fixtures agent",
    "file_type": "concept",
    "source_file": "agents/make-batch-fixtures.md",
}
_REFERENCING = {
    "id": "agents_make_batch_fixtures_make_batch_fixtures",
    "label": "make-batch-fixtures",
    "file_type": "concept",
...
def test_same_file_relabel_is_noted(capsys):
    ...
    nodes = [
        ...
        {
            "id": "agents_make_batch_fixtures_make_batch_fixtures",
            "label": "make-batch-fixtures helper agent",
            "file_type": "concept",
            "source_file": "agents/make-batch-fixtures.md",
        },
    ]
...
def test_bare_file_node_defines_its_own_id():
    ...
    assert _defines_id(
        {"id": "agents_make_batch_fixtures", "source_file": "agents/make-batch-fixtures.md"}
    )
...
def test_defines_id_helper():
    ...
    assert _defines_id({"id": "readme_booking_service", "source_file": "module-a/README.md"})
...
def test_crossfile_identical_concepts_merge_and_rewire():
    ...
    nodes = [
        ...
        {
            "id": "shenzhen_international_holdings",
            "label": "Shenzhen international",
            "file_type": "concept",
            "source_file": "doc2.md",
        },
    ...
    edges = [
        {"source": "shenzhen_international_holdings", "target": "port_ops", "relation": "operates"}
    ]
    result_nodes, result_edges = deduplicate_entities(nodes, edges, communities={})
    ids = {n["id"] for n in result_nodes}
    assert len(result_nodes) == 2
    ...
    assert result_edges == [{"source": "sz_intl", "target": "port_ops", "relation": "operates"}]
...
_RATIONALE_BOILER = (
    "Django app config for apps.platform.cards. No business "
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "id": "backend_a_render_frame",
                "label": "render_frame",
                "file_type": "code",
                "source_file": "backend_a.py",
            },
            {
                "id": "backend_b_render_frame",
                "label": "render_frame",
                "file_type": "code",
                "source_file": "backend_b.py",
            },
        ),
        (
            {
                ...
                "label": "logo.png",
                "file_type": "image",
                "source_file": "web/assets/logo.png",
            },
            {
                "id": "docs_logo",
                "label": "logo.png",
                "file_type": "image",
                "source_file": "docs/img/logo.png",
            },
        ),
        (
            {
        ...
        (
            {"id": "api_a", "label": "API", "file_type": "concept", "source_file": "doc1.md"},
            {"id": "api_b", "label": "API", "file_type": "concept", "source_file": "doc2.md"},
        ),
    ],
    ids=[
        "document",
...
def test_crossfile_concept_merge_deterministic_across_hash_seeds():
    ...
    assert results == {"1 shenzhen"}, f"non-deterministic dedup across hash seeds: {results}"
