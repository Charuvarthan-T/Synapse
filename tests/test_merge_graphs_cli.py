...
def test_merge_graphs_mixed_directed_and_multigraph(tmp_path):
    ...
    _write(a, directed=True, multigraph=False, node_id="x")
    _write(b, directed=False, multigraph=False, node_id="y")
    _write(c, directed=False, multigraph=True, node_id="z")
        ...
        json.dumps(
            {
                "directed": False,
                "multigraph": False,
                "nodes": [{"id": "app", "label": "app.js", "source_file": "app.js"}],
                "links": [],
            }
        )
    )
        ...
        json.dumps(
            {
                "directed": False,
                "multigraph": False,
                "nodes": [{"id": "app", "label": "App.jsx", "source_file": "App.jsx"}],
                "links": [],
            }
        )
    )
