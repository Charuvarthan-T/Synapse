...
def test_fabricated_code_symbol_is_downgraded(tmp_path):
    ...
    nodes = [
        ...
        {
            "id": "b",
            "label": "totally_fabricated_symbol()",
            "file_type": "code",
            "source_file": "mod.py",
        },
...
def test_qualified_and_prettified_labels_do_not_false_positive(tmp_path):
    ...
    nodes = [
        {
            "id": "a",
            "label": "PaymentProcessor.charge_card()",
            "file_type": "code",
            "source_file": "mod.py",
        },
        {
            "id": "b",
            "label": "charge_card(amount, token)",
            "file_type": "code",
            "source_file": "mod.py",
        },
    ]
...
def test_label_identifiers_helper():
    ...
    assert llm._label_identifiers("id()") == []
